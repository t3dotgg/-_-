...
export default function ಠ_ಠ() {
  ...
  return (
    <div className="flex h-screen w-screen bg-gray-800 text-gray-200 items-center justify-center overflow-hidden relative">
      ...
      <div className="flex flex-col justify-center z-50 bg-gray-600 bg-opacity-80 p-8 pb-2">
        <ʘ_ʘ emojis={emojis} />
        <button
          className="bg-gray-200 bg-opacity-40 hover:bg-opacity-60 transition p-2 m-5 text-2xl rounded-xl"
